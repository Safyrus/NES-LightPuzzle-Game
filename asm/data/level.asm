...
level_00:
    ...
    .byte MTILE::GROUND, MTILE::GROUND, MTILE::MIRROR_1, MTILE::MIRROR_2, MTILE::GROUND, MTILE::GROUND, MTILE::MIRROR_1, MTILE::GROUND, MTILE::SPE_ARRAY, (8-1), MTILE::WALL
    .byte MTILE::GROUND, MTILE::MIRROR_1, MTILE::GROUND, MTILE::MIRROR_2, MTILE::GROUND, MTILE::GROUND, MTILE::MIRROR_2, MTILE::GROUND, MTILE::SPE_ARRAY, (8-1), MTILE::WALL
    .byte MTILE::SPE_ARRAY, (8-1), MTILE::GROUND, MTILE::SPE_ARRAY, (8-1), MTILE::WALL
    .byte MTILE::GROUND, MTILE::GROUND, MTILE::MIRROR_2, MTILE::MIRROR_1, MTILE::GROUND, MTILE::GROUND, MTILE::MIRROR_1, MTILE::GROUND, MTILE::SPE_ARRAY, (8-1), MTILE::WALL
