...
level_0F:
    ...
    .byte MTILE::GROUND, MTILE::DOOR_V, MTILE::GROUND, MTILE::CROSS, MTILE::WALL, MTILE::GROUND, MTILE::GROUND, MTILE::CROSS, MTILE::WALL, MTILE::GROUND, MTILE::GROUND, MTILE::SPE_ARRAY, (2+3-1), MTILE::WALL
    ...
    .byte MTILE::GLASS, MTILE::WALL, MTILE::CROSS, MTILE::WALL, MTILE::WALL, MTILE::WALL, MTILE::CROSS, MTILE::WALL, MTILE::GLASS, MTILE::SPE_ARRAY, (3+3-1), MTILE::WALL
...
level_11:
    ...
    .byte MTILE::EMIT_UP_ON, MTILE::CROSS, MTILE::WALL, MTILE::WALL, MTILE::EMIT_UP_ON, MTILE::MIRRORC_UR, MTILE::GROUND, MTILE::GROUND, MTILE::MIRRORC_UL, MTILE::SPE_ARRAY, (13-1), MTILE::WALL
    .byte MTILE::MIRRORC_UR, MTILE::MIRRORC_UL
    .byte MTILE::SPE_ARRAY, (16*3+6-1), MTILE::WALL
